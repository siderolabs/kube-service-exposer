...
RUN FILES="$(goimports -l -local github.com/siderolabs/kube-service-exposer/ .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/kube-service-exposer/ .':\n${FILES}"; exit 1)

...
#
# Generated on 2023-08-14T14:41:33Z by kres latest.
...
all: unit-tests kube-service-exposer image-kube-service-exposer lint
...
.PHONY: $(ARTIFACTS)/kube-service-exposer-linux-amd64
$(ARTIFACTS)/kube-service-exposer-linux-amd64:
	@$(MAKE) local-kube-service-exposer-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: kube-service-exposer-linux-amd64
kube-service-exposer-linux-amd64: $(ARTIFACTS)/kube-service-exposer-linux-amd64  ## Builds executable for kube-service-exposer-linux-amd64.

.PHONY: $(ARTIFACTS)/kube-service-exposer-linux-arm64
$(ARTIFACTS)/kube-service-exposer-linux-arm64:
	@$(MAKE) local-kube-service-exposer-linux-arm64 DEST=$(ARTIFACTS)
...
image-kube-service-exposer:  ## Builds image for kube-service-exposer.
	@$(MAKE) target-$@ TARGET_ARGS="--tag=$(REGISTRY)/$(USERNAME)/kube-service-exposer:$(TAG)"
